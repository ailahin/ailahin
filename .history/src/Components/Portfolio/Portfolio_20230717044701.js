...
const Portfolio = () => {
 ...
 useEffect(()=>{
    ...
    return (
       <div className=' p-20 '>
        <div className='text-center font-extrabold text-3xl p-4 max-[400px]:text-center' id='portfolio'>
            PORTFOLIO
         </div>
    <div>
            <h1 className='text-4xl text-center text-sky-500 font-bold p-4 max-[400px]:text-center '> My Amazing Work</h1>
    </div>
