...
const Portfolio = () => {
 ...
 useEffect(()=>{
    ...
    return (
       <div className='  '>
        <div className='text-center font-extrabold text-3xl p-4 ' id='portfolio'>
            PORTFOLIO
         </div>
    <div>
            <h1 className='text-4xl text-center text-sky-500 font-bold p-4  '> My Amazing Work</h1>
    </div>
         <div className='grid  sm:justify-items-center min-[100px]:justify-items-center   lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1  md:justify-items-center gap-4 md:gap-6 sm:mt-2  p-10' >

         {
                projects.map(project=>(
                 <div className=''>
                  <a className='rounded-md  shadow-2xl bg-base-100 ' href={project.website} target="blank">
                    <div className=" rounded-md  card generated-card hover:p-1 " style={{backgroundImage:`url(${project.img})` }}>
                  <div>
         ...
         <div className="text-center p-11">
                      <a className="btn border-0  bg-gray-300 hover:bg-gray-600" href="https://github.com/ailahin" target="_blank">See more on github</a>
