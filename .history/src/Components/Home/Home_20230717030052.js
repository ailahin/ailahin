...
const Home = () => {
  return (
    <div className="mx-sm-w-full max-[500px]:mr-24 " id="home">
   ...
   <a target="_blank" href="https://www.linkedin.com/in/ailahin"> <i className="icon fa-brands fa-linkedin text-blue-600 text-4xl ml-16 mr-4"></i> </a>
    
  <a target={"_blank"} href="https://github.com/ailahin">   <i className="icon fa-brands fa-github text-blue-600 text-4xl mr-4"></i></a>
  <a href="mailto:aminulislamlahin@gmail.com" target={"_blank"}> <i className="icon fa-solid fa-envelope text-blue-600 text-4xl mr-2"></i></a>
