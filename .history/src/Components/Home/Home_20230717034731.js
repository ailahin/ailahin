...
const Home = () => {
  return (
    <div className="max-[450px]:bg-red-300" id="home">
      <div className="hero min-h-screen bg-neutral-900" id="home">
        <div className="hero-content flex-col  lg:flex-row-reverse">
          ...
          <div className=" p-11 text-slate-500 font-semibold ">
            ...
            <h1 className="text-4xl font-extrabold mt-4 text-base-300 max-[450px]:bg-red-300 max-[450px]:break-words max-[450px]:overflow-y-auto ">
  ...
  <a className="max-[400px]:invisible" href="mailto:aminulislamlahin@gmail.com" target={"_blank"}> <i className="icon fa-solid fa-envelope text-blue-600 text-4xl mr-2"></i></a>
