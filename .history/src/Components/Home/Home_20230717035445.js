...
const Home = () => {
  return (
    <div className="hero min-h-screen min-w-screen  justify-center content-center" id="home">
      <div className="hero min-h-screen bg-neutral-900" id="home">
        <div className="hero-content flex-col  lg:flex-row-reverse">
          ...
          <div className=" p-11 text-slate-500 font-semibold max-[450px]:bg-red-300 ">
