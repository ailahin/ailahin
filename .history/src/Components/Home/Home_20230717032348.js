...
const Home = () => {
  return (
   ...
   <a className="max-[400px]:flex flex-wrap" target="_blank" href="https://www.linkedin.com/in/ailahin"> <i className="icon fa-brands fa-linkedin text-blue-600 text-4xl ml-16 mr-4"></i> </a>
