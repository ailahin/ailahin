  ...
  <div class="hero-content flex-col lg:flex-row">
    <div class="text-center lg:text-left">
      ...
      <div className="flex pr-11 " style={{justifyContent:"center", alignItems:"center"}}>
        <div className=" flex " >
        <div className="bg-green-200 h-28 w-28 flex rounded-full "  style={{justifyContent:"center", alignItems:"center"}}>
        <i class="fa-solid fa-envelope"></i>
        </div>
        </div>
        <div className="flex px-4 text-xl font-bold max-[400px]:pr-20">
    ...
    <form className="card flex-shrink-0 w-full max-w-lg  shadow-2xl min-[400px]:mr-20  bg-base-100" onSubmit={handleSubmit}
