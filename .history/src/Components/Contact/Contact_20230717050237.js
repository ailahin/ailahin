...
const Contact = () => {
  ...
  <div class="hero-content flex-col lg:flex-row p-11">
    <div class="text-center lg:text-left max-[400px]:invisible max-[400px]:p-0">
    ...
    <form className="card flex-shrink-0 w-full max-w-lg   shadow-2xl   bg-base-100" onSubmit={handleSubmit}
