...
const Contact = () => {
  ...
  return (
    <div className="bg-base-200  text-center p-8 " id="contact">
      <div className="">
  ...
  <div class="hero-content flex-col lg:flex-row">
    <div class="text-center lg:text-left">
      ...
      <div className="flex pr-11 " style={{justifyContent:"center", alignItems:"center"}}>
        <div className=" flex " >
        <div className="bg-green-400 h-24 w-24 flex rounded-full "  style={{justifyContent:"center", alignItems:"center"}}>
      ...
      <div className="bg-green-400 h-24 w-24 flex rounded-full max-[400px]:bg-invisible " style={{justifyContent:"center", alignItems:"center"}}>
    ...
    <form className="card flex-shrink-0 w-full max-w-lg  shadow-2xl min-[400px]:  bg-base-100" onSubmit={handleSubmit}
