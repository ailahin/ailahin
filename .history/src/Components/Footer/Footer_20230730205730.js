...
const Footer = () => {
  ...
  <div className="grid-flow-col gap-4  sm:justify-self-center  ">
    ...
    <div className='grid-flow-col gap-4  sm:justify-self-center'> <a href="https://projects.ramunarasinga.com">
      <img src="https://visitors-count.onrender.com/api/count/incr/badge.svg?url=https://ailahin-portfolio.netlify.app"/> </a>
      </div>
